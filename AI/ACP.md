...
sequenceDiagram
    User->>MQ: Submit Order Request
    MQ-->>Order Service: Create Order
    Order Service-->> Order Service: Customer
    Order Service-->> Order Service: ATP
    Order Service-->> BMP DB: Persis
